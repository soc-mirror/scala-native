  ...
  final case class F32(value: Float)                          extends Val {
    override def equals(that: Any): Boolean =
      if (that.isInstanceOf[F32])
        java.lang.Float.floatToRawIntBits(value) == java.lang.Float.floatToRawIntBits(that.asInstanceOf[F32].value)
      else
        false
  }
  final case class F64(value: Double)                         extends Val {
    override def equals(that: Any): Boolean =
      if (that.isInstanceOf[F64])
        java.lang.Double.doubleToRawLongBits(value) == java.lang.Double.doubleToRawLongBits(that.asInstanceOf[F64].value)
      else
        false
  }
